...
public class PearsonMultiCombinationGenerator extends PearsonCombinationGenerator {
	...
	/**
	 * Transform the partitioned combinations into a pair of nl.dataeng.tue.data entries
	...
	/**
	 * Aggregates the values within the provided nl.dataeng.tue.data entries by the designated method of aggregation
	 * @param entries
	 * @return
	 */
	...
	/**
	 * Retrieves the list of countries from the nl.dataeng.tue.data entries
	 * @param dataEntries
	 * @return
	 */
