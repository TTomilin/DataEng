...
import nl.dataeng.tue.statistics.CorrelationType;
...
import static nl.dataeng.tue.data.DataFile.*;
import static nl.dataeng.tue.statistics.Aggregator.AVG;
import static nl.dataeng.tue.statistics.CorrelationType.PEARSON;
import static nl.dataeng.tue.statistics.CorrelationType.PEARSON_MULTI;
import static nl.dataeng.tue.statistics.CorrelationType.SPEARMAN;
import static nl.dataeng.tue.statistics.CorrelationType.TOTAL;
...
//		SessionWrapper.getSession().stop();
	...
	private static void logCorrelationStart(CorrelationType type, DataFile file) {
		System.out.println();
		System.out.println(String.format("Calculating %s correlation of nl.dataeng.tue.data from %s", type, file));
	}
